...
function initClient()
{
   ...
   exec("./chatHud.cs");
   exec("./messageHud.cs");
   exec("scripts/gui/touBi.cs");
   exec("scripts/gui/playGui.cs");
   exec("scripts/gui/QianMing.cs");
   exec("scripts/gui/startupGui.cs");
   exec("scripts/gui/gameSet.cs");
